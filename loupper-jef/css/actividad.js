...
$(document).ready(function(){
    ...
    function eventos(){
        ...
        $.ajax({
            ...
            dataType: 'JSON',
            type: 'GET',
            url: 'http://www.loupper.com/loupper/loupperapis/getEventos',
            data: params,
            success: function(data){
                if (data.success==true){
    ...
    $('#seguir').click(function(){
        ...
        if (relacion==0 && estado=='1'){
            ...
            ht = 'http://www.loupper.com/loupper/loupperapis/incRelacion';
            mt = 'POST';
        }else{
            params = {
                idrelacion: relacion,
            }
            ht = 'http://www.loupper.com/loupper/loupperapis/elimRelacion';
            mt = 'GET';
        }
        $.ajax({
            async:true,
    ...
    $('#opinion').click(function(){
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: 'GET',
            url: 'http://www.loupper.com/loupper/loupperapis/getOpiniones',
            data: params,
            success:  function(data){
                $('#caja').empty();
                if (data.success==true){
    ...
    $('#guardaOpinion').click(function(){
        ...
        if (validar_ob(texto)==false){
            ...
            $.ajax({
                ...
                dataType: 'json',
                type: 'POST',
                url: 'http://www.loupper.com/loupper/loupperapis/incOpinion',
                data: params,
                success:  function(data){
                        if (data.success==true){
                        ...
                        "<div class=\"col-md-3 col-lg-3\">"+
                            ...
                            "<span class=\"btn btncustom\" style=\"width:180px;height: 30px !important;padding-top: 5px !important;background-color: #434041 !important;margin-top:10px;\" onClick=\"javascript:sha_eve();\" data-sha=\"0\" id=\"btnSha\">Compartir</span>"+
                                "<div style=\"width:180px;margin-top:5px;\" id=\"sho-eve\">"+
                                 "<img src=\"../img/facebook-small.png\" class=\"puntero2\" onClick=\"javascript:shareEF('"+idp+"','"+nombre+"','"+descripcion+"','"+rutalogo+"','"+url+"')\"/>"+
