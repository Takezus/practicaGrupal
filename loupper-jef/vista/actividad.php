	...
	<input type="hidden" id="nombreusuario" name="nombreusuario">
      <div class="container visible-xs" style="width: 100%; background-color: #514f50 !important;">
        ...
        <div id="chat-container" class="col-lg-12">
            <div class="panel panel-primary" id="main_block">
            ...
            <div class="panel-collapse collapse" id="collapseOne">
              ...
              <div id="mcs_container" class="col-xs-12 panel-collapse collapse" style="display:none">
                ...
                <div class="col-xs-12" style="padding-top: 10px; padding-bottom: 10px;">
                  <div class="input-group">
                    ...
                    <span class="input-group-btn input-group-btn_change_load" style="display:none">
  	                ...
  	                <button type="button" id="attach_btn" style="width:20px; height:34px; margin-left:10px;border:0px" class="btn btn-default" onclick="$('#load-img').click();">
                    ...
                    <span class="input-group-btn">
  	                   <button  type="submit" id="send_btn" style="border:0px" class="btn btn-default" onclick="clickSendMessage()"><img src="../img/img-envia-chat.png" alt="" /></button>
                    </span>
                    </div>
