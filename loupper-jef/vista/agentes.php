<?php 
    ...
    include_once "sidebar.php"; ?>
          ...
          <input type="hidden" id="paginas" value="operadores">
        ...
        <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10 border-lista">
          <div class="row barra-age flex-parent">
             <div class="col-xs-8 col-sm-9 col-md-10 col-lg-10 flex-child"><div class="text-rbo text-10 margen-ba" id="totAgente">1 en total | 1 Operador activado(s)</div></div>
             <div class="col-xs-4 col-sm-3 col-md-2 col-lg-2  flex-child"><div class="text-rbo text-10 margen-ba2" id="totPlan">El plan 1 permite 1</div></div>
          </div>
              <div class="row separa2">
                  <div class="col-xs-12 col-sm-5 col-md-6 col-lg-6" style="padding-left: 3%;">
                    <div class="input-group">
                      <span class="input-group-addon btn-bus" style="border-bottom: 1px solid #ebebeb;"><img src="../img/cmd-search.png" ></span>
                      <input type="text" class="form-control busqueda text-rr text-10" aria-label="Amount (to the nearest dollar)" placeholder="Buscar" id="findOper">
                    </div>        
                  </div>
                  <div class="col-xs-12 col-sm-7 col-md-6 col-lg-6" class="">
                      <img src="../img/cmd-add.png" style="margin-top: 1.5%;  margin-left: 2%;" id="addOperador">
