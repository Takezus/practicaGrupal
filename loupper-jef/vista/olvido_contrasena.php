...
<body class="has-drawer">
    ...
    <div class="container" style="margin-top: 100px; margin-bottom: 50px;">
      <div class="row">
        <div class="col-xs-8 col-xs-offset-2 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
            <label class="tituloForgot">RECUPERAR CONTRASEÑA</label>
        </div>
      </div>
    </div>
    ...
    <div class="container-fluid">
         ...
         <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
            <form>
              <div class="form-group center-block" style="max-width: 522px;">
                <label for="correo" class="text-rr text-12">Ingrese el email con el que se registro y le enviaremos un email para recuperar su contraseña <span style="color: #e12f31;">*</span></label>
      ...
      <div class="row separa2">
         <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
            <a ><img src="../img/enviar.png" id="enviar" class="img-responsive center-block"></a>
         </div>
      </div>
   ...
   <script src="../controlador/olvido_contrasena.js"></script>
